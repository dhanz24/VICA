...
# from Backend.VICA.apps.VICA.routes.auth import router as auth_router
# from Backend.VICA.apps.VICA.routes.user import router as user_router
...
app.include_router(chat_router.router, prefix="/chat", tags=["Chats"])
